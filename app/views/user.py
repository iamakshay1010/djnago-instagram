...
# for taking referance for(generics)(scroll to bottom of page)
...
class UpdateUser(APIView):
    ...
    def put(self, request):
        serializer = self.serializer_class(request.user, data=request.data, partial=True) #partial to allow partial update
        if serializer.is_valid():
            serializer.save()
